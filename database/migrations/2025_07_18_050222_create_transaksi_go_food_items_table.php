...
return new class extends Migration
{
    ...
    {
        Schema::create('transaksi_go_food_items', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('transaksi_id')->references('id')->on('transaksi_go_food')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('transaksi_go_food_items');
    }
};
