...
return new class extends Migration
{
    ...
    {
        Schema::create('transaksi_grab_food_items', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('transaksi_id')->references('id')->on('transaksi_grab_food')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('transaksi_grab_food_items');
    }
};
